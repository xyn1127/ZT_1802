...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("链表头部插入15万个元素耗时"+(jssj3-kssj3)+"毫秒");
		...
		long kssj5=System.currentTimeMillis();
		test.listRead(arrayList);
		long jssj5=System.currentTimeMillis();
		System.out.println("数组列表尾部插入15万个元素耗时"+(jssj5-kssj5)+"毫秒");
	}
